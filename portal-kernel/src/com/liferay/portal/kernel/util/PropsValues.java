...
public class PropsValues {
	...
	public static final String FIPS_PROVIDER = PropsUtil.get(PropsKeys.FIPS_PROVIDER);
	...
	public static final boolean FIPS_STRICT_MODE_ENABLED = GetterUtil.getBoolean(
