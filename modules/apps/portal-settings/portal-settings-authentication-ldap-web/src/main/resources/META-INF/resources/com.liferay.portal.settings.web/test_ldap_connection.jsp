...
if (!PropsValues.FIPS_ENABLED || !FIPSModeValidator.isNotAllowedProtocol(baseProviderURL)) {
...
<c:choose>
	<c:when test="<%= PropsValues.FIPS_ENABLED && FIPSModeValidator.isNotAllowedProtocol(baseProviderURL) %>">
