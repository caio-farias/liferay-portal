...
public class FIPSLDAPAuthConfigurationModelListener
	...
	public void onBeforeSave(String pid, Dictionary<String, Object> properties)
		...
		String algorithm = GetterUtil.getString(
			properties.get(LDAPConstants.PASSWORD_ENCRYPTION_ALGORITHM));
		...
		try {
			...
			throw new LDAPConfigurationModelListenerException(
				securityException.getMessage(), LDAPAuthConfiguration.class,
				getClass(), new Object[] {algorithm},
				"the-algorithm-x-is-not-allowed-in-fips-mode", properties);
		}
	}
